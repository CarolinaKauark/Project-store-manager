...
describe('Teste de unidade do model do sales', function () {
  ...
  it('testando se lista todas as vendas', async function () {
  ...
  it('testando se retorna o sale com o id correto', async function () {
  ...
  it('testando se uma sale é adicionado', async function () {
  ...
  it('testando insertNewSale', async function () {
