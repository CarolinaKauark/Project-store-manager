...
describe('testando o controller do sales', function () {
  ...
  it('Testando a função listSales', async function () {
    const res = {};
    const req = {}
  ...
  it('Testando a função listSaleById', async function () {
    const res = {};
  ...
  it('Testando a função addSales', async function () {
  ...
  it('Testando a função deleteSaleById', async function () {
    const res = {};
  ...
  it('Testando a função updateSaleById', async function () {
    const res = {};
